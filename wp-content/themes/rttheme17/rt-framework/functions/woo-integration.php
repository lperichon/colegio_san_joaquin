...
if(!is_admin()){
	...
	wp_register_script( 'chosen', $woocommerce->plugin_url() . '/assets/js/chosen/chosen.jquery'.$suffix.'.js', "", "true");
	wp_enqueue_style('chosen', $woocommerce->plugin_url() . '/assets/css/chosen.css');
